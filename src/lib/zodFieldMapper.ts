// Готовые Zod-валидаторы и сообщения об ошибках на русском: пароль, ФИО, даты, обязательные поля.
...
export const ZOD_FIELDS = {
  ...
  invalidDateTime: (message?: string) => message ?? 'Неверная дата или время',
};
