// Панель слоёв: список, добавление и удаление.
// Слои отображаются в обратном порядке (верхний слой — первый в списке).
// Drag-and-drop реализован через HTML5 drag events с dragIdxRef для хранения индекса источника.
// Кнопки добавления создают слои с дефолтными размерами и значениями.
