// Sheet-панель для управления ресурсами: вкладки "Шрифты" и "Изображения".
// При загрузке шрифта сразу регистрирует его через FontFace API (для предпросмотра в редакторе).
// При удалении ассета, который используется в слоях, показывает ConfirmDialog с количеством зависимостей.
