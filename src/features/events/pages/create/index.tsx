// Страница создания мероприятия: форма с полями название, тип, жанр, дата, место, возраст.
// После успеха перенаправляет на страницу учреждений, вкладку мероприятий.
